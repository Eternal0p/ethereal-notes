...
// Simplified CarLights, LightsSticks, Road classes with essential functionality
class CarLights {
    webgl: App;
...
class App {
    ...
    constructor(container: HTMLElement, options: HyperspeedOptions) {
        ...
        if (!this.options.distortion || typeof this.options.distortion === 'string') {
            this.options.distortion = distortions[this.options.distortion as string] || turbulentDistortion;
        }
